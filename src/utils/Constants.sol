...
library Constants {
    ...
    uint256 public constant PAUSE_AFTER_UPDATE_ACCESS_FOR_ADMIN = 1 hours; // Pause period after access update for admin
    ...
    uint256 public constant WITHDRAW_AVAILABLE_DELAY = 1 hours; // Delay before vault withdrawal becomes available
