...
/**
 * @title NetworkConfig
 * @dev Configuration file containing asset addresses, price sources, and decimals for different networks
 * This file centralizes all network-specific configurations for price oracle deployments
 */
library NetworkConfig {
    ...
    /**
     * @dev Get network configuration for a specific chain ID
     * @param chainId The chain ID to get configuration for
     * @return NetworkAssets struct containing assets, sources, and decimals
     */
    function getNetworkConfig(uint256 chainId) internal pure returns (NetworkAssets memory) {
        if (chainId == 137) {
            // Polygon mainnet
            ...
            sources[7] = address(0x93A67D414896A280bF8FFB3b389fE3686E014fda); // XRP/USD
            ...
            address[] memory sources = new address[](13);
