...
import {MultiAdminSingleHolderAccessControlUppgradable} from "../src/utils/MultiAdminSingleHolderAccessControlUppgradable.sol";
...
contract MultiAdminSingleHolderAccessControlTest is Test {
    ...
    function setUp() public {
        ...
        bytes memory initData = abi.encodeWithSelector(
            TestMultiAdminSingleHolderAccessControl.initialize.selector, 
            admin, 
            DEFAULT_ADMIN_ROLE
        );
    ...
    function test_InitializationWithDifferentParams() public {
        ...
        TestMultiAdminSingleHolderAccessControl newAccessControl = TestMultiAdminSingleHolderAccessControl(address(newProxy));
    ...
    function test_InitializationOrder() public {
        ...
        ERC1967Proxy proxy = new ERC1967Proxy(address(implementation), initData);
        TestMultiAdminSingleHolderAccessControl newAccessControl = TestMultiAdminSingleHolderAccessControl(address(proxy));
